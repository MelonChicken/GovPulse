...
### 소스코드 라이선스 (MIT)
본 저장소의 **소스코드**는 [MIT License](LICENSE)로 배포됩니다.
상업적 사용을 포함한 광범위한 사용이 허용됩니다.
...
### 운영 원칙
본 서비스는 공공 웹페이지(.go.kr)의 공개 엔드포인트에 대해 HEAD/경량 GET 요청으로 현재 응답 상태를 표시합니다.

**준수 사항**:
- 인증이 필요한 페이지·비공개 영역은 점검하지 않음
- 페이지 본문/개인정보를 저장하지 않음
- robots.txt 완전 준수
- 기관/운영자의 모니터링 제외 요청 즉시 반영
